...
var explainCmd = &cobra.Command{
	Use:   "explain",
	Short: "Provide informations about firewall rule for the environment",
	Long:  "Provide informations about firewall rule for the environment ",
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(textCompletionResponse.Choices) > 0 {
			...
			fmt.Println("No explanation found Or API key is invalid or missing")
		}
	},
}
